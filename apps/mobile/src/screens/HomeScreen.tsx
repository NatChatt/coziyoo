        ...
        <View style={[styles.heroWrap, USE_NEW_HOME_HERO ? { height: 226, marginLeft: 0, marginRight: 0, backgroundColor: heroTopBandColor } : { height: heroDynamicHeight, backgroundColor: '#F4D6BF' }]}>
          {USE_NEW_HOME_HERO ? (
            <>
              ...
              {LinearGradient ? (
                <LinearGradient
                  colors={[toRgba(heroTopBandColor, 0), toRgba(heroTopBandColor, 0.12), toRgba(heroTopBandColor, 0.34)]}
                  locations={[0, 0.64, 1]}
                  start={{ x: 0.5, y: 1 }}
                  end={{ x: 0.5, y: 0 }}
              ...
              {LinearGradient ? (
                <LinearGradient
                  colors={[
                    ...
                    toRgba(heroBottomBandColor, 0.24),
                    toRgba(heroBottomBandColor, 0.58),
                    toRgba(heroBottomBandColor, 0.88),
                  ]}
          ...
          {LinearGradient ? (
            <LinearGradient
              colors={[
                ...
                toRgba(heroBottomBandColor, 0.26),
                toRgba(heroBottomBandColor, 0.08),
                'rgba(255, 251, 244, 0.00)',
              ]}
              locations={[0, 0.26, 0.56, 0.82, 1]}
              start={{ x: 0.5, y: 0 }}
              end={{ x: 0.5, y: 1 }}
